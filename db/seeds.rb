...
# customer3 = Customer.create(full_name:"Isaac Ngahu",age:20,email:"IsaacNgahu@gmail.com",mobile_number:254738382924,password:"Izo@Ngahu")
  ...
  # car1 = Car.create!(make:"Toyota",year:"2014",price_per_day:700.00,is_rented:false,transmission:"manual",body_type:"sedan",category:"luxury",fuel_consumption:"12L/km",no_of_seats:5,fuel_type:"gasoline")
